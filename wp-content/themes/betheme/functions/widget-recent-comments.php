					...
					$output .= '<ul>';
						foreach( $comments as $comment ){
							...
							$output .= '<li>';
								...
								$output .= '<p><i class="icon-user"></i> <strong>'. strip_tags( $comment->comment_author ) .'</strong> '. $translate['translate-commented-on'] .' <a href="'. $url .'">'. get_the_title( $comment->comment_post_ID ) .'</a></p>';
							$output .= '</li>';
						}
					$output .= '</ul>';
