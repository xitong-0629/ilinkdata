...
class WEAPP{
	...
	public function decrypt($aeskey, $iv, $encrypted_data){
		if(!class_exists('WPJAM_OPENSSL_Crypt')){
			include(WPJAM_BASIC_PLUGIN_DIR.'includes/class-wpjam-openssl-crypt.php');
		}
		...
		$wpjam_openssl_crypt	= new WPJAM_OPENSSL_Crypt($aeskey, array('method'=>'aes-128-cbc', 'iv'=>$iv));
