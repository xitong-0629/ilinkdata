...
function yp_get_font_families($css, $type) {
    ...
    foreach (array_unique($r['1']) as $family) {
        ...
        if ($type == null) {
            wp_enqueue_style($id, esc_url('' . $protocol . '://fonts.cat.net/css?family=' . $family . ':300,300italic,400,400italic,500,500italic,600,600italic,700,700italic'));
        } else {
            array_push($importArray, esc_url('' . $protocol . '://fonts.cat.net/css?family=' . $family . ':300,300italic,400,400italic,500,500italic,600,600italic,700,700italic'));
        }
